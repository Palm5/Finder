        ...
        <div class="container-fluid">
            <?php
                if(isset($_GET["error"])&&$_GET["error"]=="privilegi"){
                    echo "<p style='color:red'>Non hai i privilegi necessari per accedere alla cartella selezionata.</p>";
                }
                foreach($folders as $folder)
                {
                    ...
                    if($folder == ".."){
                        echo '<a href = "/Finder/explore.php?path='.urlencode($newpath).'"> <-- </a>' . '</br>';
                    } else {
                        echo '<a href = "/Finder/explore.php?path='.urlencode($newpath).'">
